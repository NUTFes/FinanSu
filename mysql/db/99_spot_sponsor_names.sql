...
CREATE TABLE spot_sponsor_names (
...
-- シードデータ挿入
INSERT INTO spot_sponsor_names (sponsor_name, income_expenditure_id, created_at, updated_at)
VALUES
    ("株式会社やばたにえん", 3, NOW(), NOW()); -- 企業名: 株式会社やばたにえん
