...
// BuyReportSummary 購入報告の合計情報
type BuyReportSummary struct {
	UnpackedAmountTotal  int `json:"unpackedAmountTotal"`
	UnsettledAmountTotal int `json:"unsettledAmountTotal"`
}
...
type GetBuyReportsDetailsParams struct {
	...
	// FinancialRecordName financial_record_name
