...
func (r router) ProvideRouter(e *echo.Echo) {
	...
	e.GET("/get_purchaseorders_for_view",r.purchaseOrderController.IndexOrderTieOther)
	e.GET("/get_purchaseorders_for_view/:id",r.purchaseOrderController.ShowOrderTieOther)
