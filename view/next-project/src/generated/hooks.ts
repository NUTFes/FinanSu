...
export const getPutExpensesIdUrl = (id: number,
  ...
  return normalizedParams.size ? `/expenses/${id}?${normalizedParams.toString()}` : `/expenses/${id}`
}
...
export const getExpensesFiscalyearYear = async (year: number, options?: RequestInit): Promise<getExpensesFiscalyearYearResponse> => {
  ...
  return customFetch<Promise<getExpensesFiscalyearYearResponse>>(getGetExpensesFiscalyearYearUrl(year),
  {      
    ...options,
    method: 'GET'
 ...
 */
export type getFinancailRecordsResponse = {
  data: FinancialRecordDetails;
  status: number;
  headers: Headers;
}

export const getGetFinancailRecordsUrl = () => {


  return `/financail_records`
}

export const getFinancailRecords = async ( options?: RequestInit): Promise<getFinancailRecordsResponse> => {
  
  return customFetch<Promise<getFinancailRecordsResponse>>(getGetFinancailRecordsUrl(),
  {      
    ...options,
    method: 'GET'
...
export const getGetFinancailRecordsKey = () => [`/financail_records`] as const;

export type GetFinancailRecordsQueryResult = NonNullable<Awaited<ReturnType<typeof getFinancailRecords>>>
export type GetFinancailRecordsQueryError = unknown

export const useGetFinancailRecords = <TError = unknown>(
   options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof getFinancailRecords>>, TError> & { swrKey?: Key, enabled?: boolean }, request?: SecondParameter<typeof customFetch> }
) => {
  const {swr: swrOptions, request: requestOptions} = options ?? {}

  const isEnabled = swrOptions?.enabled !== false
  const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getGetFinancailRecordsKey() : null);
  const swrFn = () => getFinancailRecords(requestOptions)
...
export const getPostFinancailRecordsUrl = () => {
...
export const getPostFinancailRecordsMutationFetcher = ( options?: SecondParameter<typeof customFetch>) => {
  return (_: Key, { arg }: { arg: FinancialRecord }): Promise<postFinancailRecordsResponse> => {
    return postFinancailRecords(arg, options);
  }
}
export const getPostFinancailRecordsMutationKey = () => [`/financail_records`] as const;

export type PostFinancailRecordsMutationResult = NonNullable<Awaited<ReturnType<typeof postFinancailRecords>>>
export type PostFinancailRecordsMutationError = unknown

export const usePostFinancailRecords = <TError = unknown>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postFinancailRecords>>, TError, Key, FinancialRecord, Awaited<ReturnType<typeof postFinancailRecords>>> & { swrKey?: string }, request?: SecondParameter<typeof customFetch>}
) => {

  const {swr: swrOptions, request: requestOptions} = options ?? {}

  const swrKey = swrOptions?.swrKey ?? getPostFinancailRecordsMutationKey();
...
export const getPutFinancailRecordsIdUrl = (id: number,) => {


  return `/financail_records/${id}`
}
...
export const getPutFinancailRecordsIdMutationFetcher = (id: number, options?: SecondParameter<typeof customFetch>) => {
  return (_: Key, { arg }: { arg: FinancialRecord }): Promise<putFinancailRecordsIdResponse> => {
    return putFinancailRecordsId(id, arg, options);
  }
}
export const getPutFinancailRecordsIdMutationKey = (id: number,) => [`/financail_records/${id}`] as const;

export type PutFinancailRecordsIdMutationResult = NonNullable<Awaited<ReturnType<typeof putFinancailRecordsId>>>
export type PutFinancailRecordsIdMutationError = unknown

export const usePutFinancailRecordsId = <TError = unknown>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putFinancailRecordsId>>, TError, Key, FinancialRecord, Awaited<ReturnType<typeof putFinancailRecordsId>>> & { swrKey?: string }, request?: SecondParameter<typeof customFetch>}
) => {

  const {swr: swrOptions, request: requestOptions} = options ?? {}

  const swrKey = swrOptions?.swrKey ?? getPutFinancailRecordsIdMutationKey(id);
  const swrFn = getPutFinancailRecordsIdMutationFetcher(id, requestOptions);
...
export const getDeleteFinancailRecordsIdUrl = (id: number,) => {


  return `/financail_records/${id}`
}

export const deleteFinancailRecordsId = async (id: number, options?: RequestInit): Promise<deleteFinancailRecordsIdResponse> => {
  
  return customFetch<Promise<deleteFinancailRecordsIdResponse>>(getDeleteFinancailRecordsIdUrl(id),
  {      
    ...options,
    method: 'DELETE'
...
export const getDeleteFinancailRecordsIdMutationFetcher = (id: number, options?: SecondParameter<typeof customFetch>) => {
  return (_: Key, __: { arg: Arguments }): Promise<deleteFinancailRecordsIdResponse> => {
    return deleteFinancailRecordsId(id, options);
  }
}
export const getDeleteFinancailRecordsIdMutationKey = (id: number,) => [`/financail_records/${id}`] as const;

export type DeleteFinancailRecordsIdMutationResult = NonNullable<Awaited<ReturnType<typeof deleteFinancailRecordsId>>>
export type DeleteFinancailRecordsIdMutationError = unknown

export const useDeleteFinancailRecordsId = <TError = unknown>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof deleteFinancailRecordsId>>, TError, Key, Arguments, Awaited<ReturnType<typeof deleteFinancailRecordsId>>> & { swrKey?: string }, request?: SecondParameter<typeof customFetch>}
) => {

  const {swr: swrOptions, request: requestOptions} = options ?? {}

  const swrKey = swrOptions?.swrKey ?? getDeleteFinancailRecordsIdMutationKey(id);
  const swrFn = getDeleteFinancailRecordsIdMutationFetcher(id, requestOptions);
