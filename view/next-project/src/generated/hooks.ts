...
export type postIncomeExpenditureManagementsCheckIdResponseComposite =
  postIncomeExpenditureManagementsCheckIdResponse200;

export type postIncomeExpenditureManagementsCheckIdResponse =
  postIncomeExpenditureManagementsCheckIdResponseComposite & {
    headers: Headers;
  };
...
export const postIncomeExpenditureManagementsCheckId = async (
  id: number,
  postIncomeExpenditureManagementsCheckIdBody: PostIncomeExpenditureManagementsCheckIdBody,
  options?: RequestInit,
): Promise<postIncomeExpenditureManagementsCheckIdResponse> => {
  return customFetch<postIncomeExpenditureManagementsCheckIdResponse>(
    getPostIncomeExpenditureManagementsCheckIdUrl(id),
    {
      ...options,
      method: 'POST',
      headers: { 'Content-Type': 'application/json', ...options?.headers },
      body: JSON.stringify(postIncomeExpenditureManagementsCheckIdBody),
    },
  );
};

export const getPostIncomeExpenditureManagementsCheckIdMutationFetcher = (
  id: number,
  options?: SecondParameter<typeof customFetch>,
) => {
  return (
    _: Key,
    { arg }: { arg: PostIncomeExpenditureManagementsCheckIdBody },
  ): Promise<postIncomeExpenditureManagementsCheckIdResponse> => {
    return postIncomeExpenditureManagementsCheckId(id, arg, options);
  };
};
export const getPostIncomeExpenditureManagementsCheckIdMutationKey = (id: number) =>
  [`/income_expenditure_managements/check/${id}`] as const;

export type PostIncomeExpenditureManagementsCheckIdMutationResult = NonNullable<
  Awaited<ReturnType<typeof postIncomeExpenditureManagementsCheckId>>
>;
