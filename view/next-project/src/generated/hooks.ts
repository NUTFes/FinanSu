...
export type putIncomeExpenditureManagementsCheckIdResponseComposite = putIncomeExpenditureManagementsCheckIdResponse200;
    
export type putIncomeExpenditureManagementsCheckIdResponse = putIncomeExpenditureManagementsCheckIdResponseComposite & {
  headers: Headers;
}
...
export const getPutIncomeExpenditureManagementsCheckIdMutationFetcher = (id: number, options?: SecondParameter<typeof customFetch>) => {
  return (_: Key, { arg }: { arg: PutIncomeExpenditureManagementsCheckIdBody }): Promise<putIncomeExpenditureManagementsCheckIdResponse> => {
