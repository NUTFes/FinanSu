...
const OpenAddModal: FC<ModalProps> = (props) => {
  ...
  return (
    <Modal className='md:w-1/2'>
      ...
      <h1 className='text-black-600 mx-auto mb-10 w-fit text-xl'>年度の登録</h1>
      <div className='my-6 grid grid-cols-5 place-items-center gap-4'>
        <p className='text-black-600 col-span-2'>年度</p>
        ...
        <p className='text-black-600 col-span-2'>開始日</p>
        <div className='col-span-3 w-full'>
          <Input type='date' onChange={handler('startedAt')} className='w-full' />
        </div>
        <p className='text-black-600 col-span-2'>終了日</p>
        <div className='col-span-3 w-full'>
