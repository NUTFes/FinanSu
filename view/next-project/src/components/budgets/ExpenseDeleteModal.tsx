...
const ExpenseDeleteModal: FC<ModalProps> = (props) => {
  ...
  const deleteExpense = async (id: number | string) => {
    const deletePurchaseReportUrl = process.env.CSR_API_URI + '/expenses/' + id;
  ...
  return (
    <Modal className='md:w-1/2'>
      ...
      <div className='mx-auto mb-5 w-fit text-xl text-black-600'>支出の削除</div>
