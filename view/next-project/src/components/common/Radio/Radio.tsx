    ...
    <label className={clsx('group flex cursor-pointer items-center gap-2', className)}>
      <div className='relative flex size-4 shrink-0 items-center justify-center'>
        <input
          ...
          onClick={onClick}
          className='border-primary-1 bg-white-0 group-hover:border-primary-2 checked:border-primary-1 focus-visible:ring-primary-1 peer size-full cursor-pointer appearance-none rounded-full border-2 transition-all focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none'
        />
