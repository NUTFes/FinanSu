...
function Loading(props: Props) {
  ...
  return (
    <>
      <div className='bg-black-300/50 outline-hidden focus:outline-hidden fixed inset-0 z-50 flex items-center justify-center overflow-y-auto overflow-x-hidden'>
