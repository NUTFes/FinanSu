      ...
      <div className='my-16 flex w-full flex-col items-center'>
        <div className='mb-10 flex flex-col gap-3'>
          <div className='grid grid-cols-3 items-center justify-items-end gap-5'>
            <p className='md:text-md text-black-300 whitespace-nowrap text-sm'>名前</p>
            <input
            ...
            />
            <p className='md:text-md text-black-300 whitespace-nowrap text-sm'>学科</p>
            <select
              className='border-b-primary-1 col-span-2 w-full border-b p-1'
            ...
            <p className='md:text-md text-black-300 whitespace-nowrap text-sm'>メールアドレス</p>
            <input
              className='border-b-primary-1 col-span-2 w-full border-b p-1'
              type='text'
              {...register('email', {
            ...
            />
            <p className='md:text-md text-black-300 whitespace-nowrap text-sm'>パスワード</p>
            <input
              className='border-b-primary-1 col-span-2 w-full border-b p-1'
              type='password'
              {...register('password', {
            ...
            />
            <p className='md:text-md text-black-300 whitespace-nowrap text-sm'>パスワード確認</p>
            <input
              className='border-b-primary-1 col-span-2 w-full border-b p-1'
              type='password'
